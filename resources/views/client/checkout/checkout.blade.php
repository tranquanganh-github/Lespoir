                                    ...
                                    <div class="card-body">
                                        <div class="billing-address-form">
                                            <form action="">
                                                ...
                                                <p><input type="tel" value="{{$user->phone ?? ""}}" name="phone"
                                                          placeholder="Phone"></p>
                                ...
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                    ...
                                    <div class="card-body">
                                        <div class="card-details">
                                            <form action="{{route('payment.paypal')}}" name="paypal" method="POST">
                                                <button type="submit"  style="border: none;background: none">
                                                    <img
                                                            src="https://www.paypalobjects.com/digitalassets/c/website/marketing/apac/C2/logos-buttons/44_Yellow_CheckOut_Pill_Button.png"
